...
import { FullstackcobaClient } from '../contracts/clients/FullstackcobaClient';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: FullstackcobaClient;

describe('Fullstackcoba', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new FullstackcobaClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
